...
<html lang="en">
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="user.php"><strong>CV. Mitra Karya Mandiri</strong></a>
  ...
  <!-- Awal Footer -->
      ...
      <div class="container">
        <div class="row footer-body">
          ...
          <a href="https://api.whatsapp.com/send/?phone=628988185642&text&app_absent=0"><img src="images/icon/wa12.png" class="mr-3" data-toggle="tooltip" title="Whatsapp"></a>
